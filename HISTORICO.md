...
- O digest é calculado sobre `infMDFe` em C14N inclusivo
...
## Consulta com fallback de action + save sem migration (25/09/2026)- SVRS rejeitou as duas formas da action de consulta em momentos
...
## Reaproveitar transbordo rejeitado (25/09/2026)

- Tentar de novo num transbordo rejeitado errava "sem CT-es vinculados":
