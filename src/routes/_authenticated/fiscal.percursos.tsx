...
<div className="flex items-center gap-1"><span className="text-[9px] text-muted-foreground w-12 shrink-0">Dist.</span><Input className="h-6 text-[11px] flex-1 min-w-0" value={editing.distancia_km || ""} onChange={e => set("distancia_km", e.target.value)} /><span className="text-[9px] text-muted-foreground shrink-0">km</span></div>
<div className="flex items-center gap-1"><span className="text-[9px] text-muted-foreground w-12 shrink-0">Dur.</span><Input className="h-6 text-[11px] flex-1 min-w-0" value={editing.duracao_horas || ""} onChange={e => set("duracao_horas", e.target.value)} /><span className="text-[9px] text-muted-foreground shrink-0">h</span></div>
</div>
                    </div>
                  </div>
