  ...
  const gerarDacteBlob = async (doc: CteDoc): Promise<Blob> => {
    ...
    try {
      ...
      try {
        ...
        expEndereco: ((tag("infCte > exped > enderExped > xLgr") || "") + ((tag("infCte > exped > enderExped > nro") || "") ? ", " + tag("infCte > exped > enderExped > nro") : "")).trim(),
        ...
        recEndereco: ((tag("infCte > receb > enderReceb > xLgr") || "") + ((tag("infCte > receb > enderReceb > nro") || "") ? ", " + tag("infCte > receb > enderReceb > nro") : "")).trim(),
            ...
            <TabsContent value="seguros" className="mt-1">
              ...
              <Card className="p-1.5">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-1 mt-0.5">
                  ...
                  <div className="md:col-span-2"><Label className="text-[10px] text-muted-foreground">Vale Pedágio (R$)</Label><MoneyInput className="h-6 text-[11px] font-medium" disabled={pagtoSeguro(form.pedagioPagto) === "sem-pagamento"} value={form.valePedagio} onChange={v => setForm(f => ({ ...f, valePedagio: v }))} /></div>
